...
// Shared helper so every hand-rolled fetch in this file sends auth the
// same way the rest of the app does (Bearer token from localStorage),
// instead of relying on cookies which this app doesn't actually use.
...
export default function DigiCoinApp() {
  // `user` is the authenticated Laravel user (from Sanctum bearer token).
